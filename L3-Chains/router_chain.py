...
# TODO: something is wrong on default chain with latest langchain version
# solution 1: downgrade langchain version to 0.0.139
# solution 2: fix with latest version in the future
result = chain.invoke({"input": "Why does every cell in our body contain DNA?"})
